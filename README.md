...
5.	Folder location This code expects the extracted dataset folders to be in one of these locations:
...
6.	How to run Open JupyterLab and run the "pipeline" code and it will find *_pos.csv automatically It will compute the five kinematic features, labels and LOSO evaluation
